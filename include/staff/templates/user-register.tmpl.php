...
below to create a customer account for <b><?php echo
...
<div id="user-registration" style="display:block; margin:5px;">
    <form method="post" class="user"
        ...
        <tbody>
            <tr>
                <th colspan="2">
                    <em><strong>Customer Account Login</strong></em>
                </th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan=2>
                    ...
                    <input type="checkbox" name="forbid-pwreset-flag" value="1" <?php
                        echo $info['forbid-pwreset-flag'] ?  'checked="checked"' : ''; ?>> Customer cannot change password
                </td>
            </tr>
        </tbody>
        <tbody>
            <tr>
                <th colspan="2"><em><strong>Customer Preferences</strong></em></th>
            </tr>
                <td>Time Zone:</td>
                <td>
