...
<div id="user-profile" style="display:<?php echo $forms ? 'none' : 'block'; ?>;margin:5px;">
    ...
    <a class="action-button pull-right change-user" style="overflow:inherit"
        href="#tickets/<?php echo $ticket->getId(); ?>/change-user" ><i class="icon-user"></i> Change Customer</a>
    <?php
    } ?>
    <div><b><?php
...
<ul class="tabs" style="margin-top:5px">
    <li><a href="#info-tab" class="active"><i class="icon-info-sign"></i>&nbsp;Customer</a></li>
<?php if ($org) { ?>
